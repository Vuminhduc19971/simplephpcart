...
<div class="container">
    ...
    <table class="table table-hover">
        ...
        <?php  $total=0; foreach ($_SESSION['cart_item'] as $key_car =>$val_cart_item) :?>
        <tr>
            <td><?php echo $val_cart_item['id'] ?></td>
            <td><?php echo $val_cart_item['product_name'] ?></td>
            <td><img class="card-img-top" data-src="camera.jpg" style="height :30px; width: auto; display: block;" src="image/<?php echo $val_cart_item['product_image']?>" data-holder-rendered="true"></td>
...
<div class="container" style="margin-top:60px; margin-right: 185px">
    <div class="row">
        <?php
        ...
        <div class="col-sm-6">
            <form name="product1"<?php echo $product['id'] ?>  action="process.php"  method="post">
                <div class="card mb-4 box-shadow">
                    <img class="card-img-top" data-src="camera.jpg" style="height :315px; width: 100%; display: block;" src="image/<?php echo $product['product_image']?>" data-holder-rendered="true">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="form-inline">
                                ...
                                <label style="margin-left: 10px">
                                    <input type="submit" name="submit" class="btn btn-sm btn-outline-secondary" value="Thêm vào giỏ hàng"></label>
                            </div>
                        </div>
                </div>
            </form>
